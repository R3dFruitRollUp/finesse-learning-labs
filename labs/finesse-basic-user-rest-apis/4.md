## Step 4: Sign in userA to Finesse
...
In this step, you will sign in UserA using the Finesse REST API and expect a Finesse notification with UserA in NOT_READY state.

1. Open a new tab in **Postman**. As suggested in the previous step, it is not recommended to click the Reset button.

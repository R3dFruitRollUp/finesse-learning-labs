## Step 5: Sign out UserA from Finesse
...
4. To confirm that the user was logged out successfully, use the GET user API from the **Step 2: Get the user information section** and verify that the ``<state>`` tag value is LOGOUT. If you kept the tab from Step 2 opened, switch back to that tab and click the **Send** button.

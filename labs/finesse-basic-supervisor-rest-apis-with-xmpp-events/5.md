 ...
 * In the field marked *Enter request URL here*, put the URL for the Finesse API ``/Team`` resource where {teamId} is the id of the team the user supervises which you had copied to the text editor in <a href="/lab/finesse-basic-supervisor-rest-apis-with-xmpp-events/step/4">Step #4</a>:
